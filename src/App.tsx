...
import BrokerConsents from './components/BrokerConsents';
...
import AdminNotifications from './components/AdminNotifications';  // ⬅️ ADD THIS
import AdminApprovalsNew from './components/AdminApprovalsNew';
    ...
    <Router basename="/">
      <AuthProvider>
        <Routes>
          ...
          />
          <Route 
            path="/broker/consents" 
            element={isAuthenticated && userRole === 'broker' ? 
              <BrokerConsents onLogout={handleLogout} /> : 
              <Navigate to="/login" />
            } 
          />
          <Route 
          ...
          <Route 
            ...
            element={isAuthenticated && userRole === 'admin' ? 
              <AdminApprovalsNew onLogout={handleLogout} /> : 
              <Navigate to="/login" />
            } 
          />
          <Route 
