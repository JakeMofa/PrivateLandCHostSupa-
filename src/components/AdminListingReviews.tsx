...
export default function AdminListingReviews({ onLogout }: AdminListingReviewsProps) {
  ...
  const handleRequestRevision = (id: number) => {
    console.log(`Requesting revision for listing #${id}`);
    setDialogOpen(false);
  };
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <Card className="bg-gradient-to-br from-[#1a1a1a] to-[#0f0f0f] border-[#2a2a2a]">
            <CardContent className="pt-6">
              ...
              <p className="text-gray-400 text-sm mb-1">Approved Today</p>
          ...
          <Card className="bg-gradient-to-br from-[#1a1a1a] to-[#0f0f0f] border-[#2a2a2a]">
            <CardContent className="pt-6">
              ...
              <p className="text-white text-2xl">$127M</p>
            </CardContent>
          </Card>
        </div>
              ...
              <TableBody>
                {pendingListings.map((listing) => (
                  <TableRow key={listing.id} className="border-[#2a2a2a] hover:bg-[#2a2a2a]/30">
                    ...
                    <TableCell>
                      <div>
                        <p className="text-white">{listing.broker}</p>
                        <p className="text-gray-400 text-sm">{listing.brokerage}</p>
                      </div>
                    </TableCell>
                    <TableCell className="text-[#d4af37]">
                      ${(listing.price / 1000000).toFixed(1)}M
                    </TableCell>
                    <TableCell className="text-white">{listing.location}</TableCell>
                    <TableCell>
                      <Badge className={
                  ...
                  {selectedListing.consentVerified ? (
                    ...
                    <div className="flex-1 p-4 bg-red-500/5 rounded-lg border border-red-500/30">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <p className="text-red-400 mb-2">Consent-to-List document required</p>
                          <p className="text-gray-400 text-sm">
                            Contact broker to provide signed Consent-to-List agreement before approval.
                          </p>
                        </div>
                      </div>
                    </div>
